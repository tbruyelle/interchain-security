...
func TestValidateParams(t *testing.T) {
	testCases := []struct {
		...
		{"custom valid params", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
		...
		{"custom invalid params", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
		...
		{"blank client", types.NewParams(&ibctm.ClientState{},
			"0.33", time.Hour, time.Hour, time.Hour, 30*time.Minute, "0.1", 100), false},
		...
		{"0 trusting period fraction", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
			"0.00", time.Hour, time.Hour, time.Hour, 30*time.Minute, "0.1", 100), true},
		{"0 ccv timeout period", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
			"0.33", 0, time.Hour, time.Hour, 30*time.Minute, "0.1", 100), false},
		{"0 init timeout period", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
			"0.33", time.Hour, 0, time.Hour, 30*time.Minute, "0.1", 100), false},
		{"0 vsc timeout period", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
			"0.33", time.Hour, time.Hour, 0, 30*time.Minute, "0.1", 100), false},
		{"0 slash meter replenish period", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
			"0.33", time.Hour, time.Hour, 24*time.Hour, 0, "0.1", 100), false},
		{"slash meter replenish fraction over 1", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
			"0.33", time.Hour, time.Hour, 24*time.Hour, time.Hour, "1.5", 100), false},
		{"negative max pending slash packets", types.NewParams(ibctm.NewClientState("", ibctm.DefaultTrustLevel, 0, 0,
			time.Second*40, clienttypes.Height{}, commitmenttypes.GetSDKSpecs(), []string{"ibc", "upgradedIBCState"}, true, false),
